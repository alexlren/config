...
(custom-theme-set-faces
 'monokai-nox
 '(default ((t (:family "Monospace" :foundry "unknown" :width normal :height 100 :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :stipple nil :inherit nil))))
 ...
 '(whitespace-trailing ((t (:background "brightred"))))
 ...
 '(font-lock-type-face ((t (:foreground "color-117"))))
 ...
 '(mode-line ((t (:box (:line-width -1 :color nil :style released-button) :foreground "#eeeeec" :background "DodgerBlue4"))))
